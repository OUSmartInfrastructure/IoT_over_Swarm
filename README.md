...
** a. This is achieved through the deployment of IoT devices that communicate with Swarm M138 boards over the spacebee satellite network .
** b. The project utilizes the Swarm Pass Checker tool to efficiently monitor satellite passes over specific locations and times, enhancing coordination of satellite communication .
** C. The project leverages the capabilities of the Adafruit QT Py ESP32 for WIFI-over-Serial connectivity, allowing for wireless exchange of information, commands, and data with the Swarm M138 board .
